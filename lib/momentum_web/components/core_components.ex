defmodule MomentumWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(MomentumWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(MomentumWeb.Gettext, "errors", msg, opts)
    end
  end
