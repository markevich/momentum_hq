defmodule MomentumHqWeb.CoreComponents do
  @moduledoc """
  ...
  def simple_form(assigns) do
    ...
    <.form :let={f} for={@for} as={@as} {@rest}>
      <div class="mt-10 space-y-5 bg-white">
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(MomentumHqWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(MomentumHqWeb.Gettext, "errors", msg, opts)
    end
  end
